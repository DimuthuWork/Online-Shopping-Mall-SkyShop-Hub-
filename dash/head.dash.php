...
<?php
    ...
    if(!isset($_SESSION['a_id'])) {
        header("Location: ../adminlogin.php"); // Redirect non-logged-in users to the login page
        exit();
    }
...
<div class="app-container">
    <div class="sidebar">
        <div class="sidebar-header">
            ...
            <span> SkyShop Hub</span>
            </div>
        </div>
        <ul class="sidebar-list">
            <li class="sidebar-list-item <?php echo ($currentPage == 'users.php') ? 'active' : ''; ?>">
                <a href="users.php">
                    <span>Users</span>
                </a>
            </li>
            <li class="sidebar-list-item <?php echo ($currentPage == 'products.php') ? 'active' : ''; ?>">
                <a href="products.php">
                    <span>Products</span>
                </a>
            </li>
            ...
            <li class="sidebar-list-item <?php echo ($currentPage == 'feedback.php') ? 'active' : ''; ?>">
                <a href="feedback.php">
    ...
    <button class="app-content-deleteButton" onclick="window.location.href = '../php/fnc.logout.php';">logout</button>
  </div>